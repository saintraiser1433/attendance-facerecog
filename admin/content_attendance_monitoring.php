...
<div class="monitoring-card">
    ...
    <p style="color:#555;font-size:14px;"><i class="fas fa-sms"></i> While you are logged into the <strong>admin panel</strong> (any page), the system checks every <strong>2 seconds</strong> for students marked <strong>Absent</strong> on <strong>both yesterday and today</strong> (two times in a row). It then sends <strong>one SMS per student</strong> to the parent/guardian (via <a href="?page=sms_settings">SMS Settings</a>). The emergency contact number is tried first, then the student phone; numbers must be valid <strong>+639</strong> mobiles.</p>
