        ...
        if (empty($first_name) || empty($last_name) || empty($email)) {
            ...
            if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
                ...
                if (mysqli_num_rows($check_result) > 0) {
                    ...
                    mysqli_stmt_bind_param($stmt, "ssssssisdsss", $first_name, $last_name, $email, $phone, $specialization, $qualification, $experience_years, $hourly_rate, $address, $profile_picture, $status, $hire_date);
                    ...
                    if (mysqli_stmt_execute($stmt)) {
                        ...
                        // Create user account for the tutor with 'user' role
                        ...
                        // Insert user account with 'user' role and set teacher_id
                        $user_sql = "INSERT INTO users (username, password, role, name, teacher_id) VALUES (?, ?, 'user', ?, ?)";
                        ...
                        if (mysqli_stmt_execute($user_stmt)) {
                            ...
                            // Delete the tutor record since we couldn't create the user account
                            $delete_sql = "DELETE FROM tutors WHERE id = ?";
                            $delete_stmt = mysqli_prepare($conn, $delete_sql);
                            mysqli_stmt_bind_param($delete_stmt, "i", $last_tutor_id);
...
<body>
        ...
        <div class="card">
            ...
            <?php if ($success_message): ?>
                ...
                <div class="card" style="margin-bottom:20px;">
                    ...
                    <p>Click the button below to scan and enroll the tutor's fingerprint. You can also enroll later from admin.</p>
                    ...
                    <button id="btn-enroll-tutor" class="btn btn-primary"><i class="fas fa-fingerprint"></i> Scan & Enroll Now</button>
    ...
    <script>
    (function(){
        var btn = document.getElementById('btn-enroll-tutor');
        if (btn) {
            ...
            btn.addEventListener('click', async function(){
                ...
                try{
                    // Capture first
                    var captured = await Fingerprint.capture();
                    // Verify to set indicator
                    var body = new URLSearchParams();
                    body.append('user_type','tutor');
                    ...
                    var currentId = <?php echo isset($last_tutor_id) ? (int)$last_tutor_id : 0; ?>;
                    ...
                    // Enroll captured template for this tutor
                    var ebody = new URLSearchParams();
                    ebody.append('user_id', String(currentId));
                    ebody.append('user_type', 'tutor');
